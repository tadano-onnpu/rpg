...
TUG.mFPS          = 60;  //フレームレート
TUG.mHeight       = 120; //仮想画面の高さ
TUG.mWidth        = 128; //仮想画面の幅

TUG.onTimer = function(){}

TUG.init = function(){
  TUG.GR.mCanvas = document.createElement("canvas"); //仮想画面の作成
  TUG.GR.mCanvas.width = TUG.mWidth; //仮想画面の幅設定
  TUG.GR.mCanvas.height = TUG.mHeight; //仮想画面の高さ設定
  TUG.GR.mG = TUG.GR.mCanvas.getContext("2d"); //仮想画面の2Dコンテキストを取得
